...
import argparse
import numpy as np
from create_ome_zarr import create_ome_zarr, INTERPOLATOR_MAPPING, RawDataSource
...
if __name__ == '__main__':
    ...
    data_source = RawDataSource(args.files, args.size, dtype_mapping[args.dtype], args.axisorder)
